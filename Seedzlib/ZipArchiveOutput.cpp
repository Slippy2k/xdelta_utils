...
bool zip::ZipArchiveOutput::Open(tstring const& archiveName, bool utf8fileNames, int compressionLevel)
{
...
bool zip::ZipArchiveOutput::WriteFile(tstring const& fileName, const void* pMemoryBlock, size_t size)
{
...
tstring zip::ZipArchiveOutput::ErrorMessage() const
{
